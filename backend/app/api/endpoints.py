...
from app.api.routers.selection_plans import router as selection_plans_router
from app.api.routers.students import router as students_router
from app.api.routers.teacher_adjustments import router as teacher_adjustments_router
...
api_v1_router.include_router(selection_plans_router)
api_v1_router.include_router(teachers_router)
api_v1_router.include_router(teacher_adjustments_router)
