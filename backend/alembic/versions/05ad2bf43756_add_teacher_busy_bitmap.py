...
def upgrade() -> None:
    # The current baseline already creates this table. Keep the guard for databases
    # that were initialized from an older copy of the baseline migration.
    if not sa.inspect(op.get_bind()).has_table("teacher_availability"):
